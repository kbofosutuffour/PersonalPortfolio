...
export default function WorkExperience() {
    ...
    const workExperiences = ['paradyme', 'aiddata', 'chesterfield']
        ...
        <div id="workexperience" className='border border-dark p-5 m-md-5 mt-5 d-flex flex-column justify-content-center align-items-center rounded'>
            <h3><u>Work Experience</u></h3>
                <div className='d-none d-md-flex flex-row justify-content-center align-items-center' style={{columnGap: '30px'}}>
                    <div style={{textDecoration: workExperiences[index] == 'paradyme' ? 'underline' : 'none', fontSize: 'larger'}} onClick={() => setIndex(0)}>Paradyme Management</div>
                    <div style={{textDecoration: workExperiences[index] == 'aiddata' ? 'underline' : 'none', fontSize: 'larger'}} onClick={() => setIndex(1)}>AidData</div>
                    <div style={{textDecoration: workExperiences[index] == 'chesterfield' ? 'underline' : 'none', fontSize: 'larger'}} onClick={() => setIndex(2)}>Chesterfield County IST</div>
                </div>
                    ...
                    <div className='column row-md p-md-5 d-flex flex-column-reverse flex-md-row justify-content-center align-items-center'>
                        <div className='col-md'>
                            <div title='Click the picture to access its source'>
                                <a href='https://www.pinterest.com/pin/810718370404271720/'><img style={{width: 200}} src={paradyme}/></a>
                            </div>
                        </div>
                        <div className='col-md-9'>
                            <h5>Paradyme: Software Developer</h5>
                            <span>
                            I collaborated with C3.AI to design, develop, and maintain advanced technical AI solutions, playing a crucial role in the overall project lifecycle. 
                ...
                {<Collapse in={workExperiences[index] == 'aiddata'}>
                    <div>
                        <div className='column row-md p-md-5 d-flex flex-column-reverse flex-md-row justify-content-center align-items-center'>
                            <div className='col-md'>
                                <div title='Click the picture to access its source'>
                                    <a href='https://www.pinterest.com/pin/810718370404271720/'><img style={{width: 200, border: '1px solid black'}} src={aiddata}/></a>
                                </div>
                            </div>
                            <div className='col-md-9'>
                                <h5>AidData: Software Developer Assistant</h5>
                                <span>        
                                I worked closely with William and Mary’s Global Research Institute Finance team, specifically with their Foreign Development Finance Team, on various projects. 
                ...
                {<Collapse in={workExperiences[index] == 'chesterfield'}>
                    <div>
                        <div className='column row-md p-md-5 d-flex flex-column-reverse flex-md-row justify-content-center align-items-center'>
                            <div className='col-md'>
                                <div title='Click the picture to access its source'>
                                    <a href='https://www.pinterest.com/pin/810718370404271720/'><img style={{width: 200}} src={chesterfield} /></a>
                                </div>
                            </div>
                            <div className='col-md-9'>
